#!/bin/bash
#SBATCH --job-name=3.2B_Chandra2018_SB_1p.sh                                #Job name
#SBATCH --partition=batch		                                        #Partition (queue) name
#SBATCH --ntasks=4			                                            #Single task job
#SBATCH --cpus-per-task=12                                          #Number of cores per task
#SBATCH --mem=24gb			                                            #Total memory for job
#SBATCH --time=24:00:00  		                                        #Time limit hrs:min:sec
#SBATCH --output=/home/ahw22099/Alignment_to_UNIL_3.4/3.2B_Chandra2018_SB_1p.log.%j			    #Standard output
#SBATCH --error=/home/ahw22099/Alignment_to_UNIL_3.4/3.2B_Chandra2018_SB_1p.err.%j		    #Standard error log
...
STAR_genome_SB="/scratch/ahw22099/UNIL_3.4_Alignment/Chandra2018_STAR_genome_SB"
if [ ! -d $STAR_genome_SB ]
then
...
##1st pass
Chandra2018_STAR_SB="/scratch/ahw22099/UNIL_3.4_Alignment/Chandra2018_STAR_SB"
if [ ! -d $ArsenaultKing2020_STAR_SB ]
then
mkdir -p $ArsenaultKing2020_STAR_SB
fi

FirstPass_SB="/scratch/ahw22099/UNIL_3.4_Alignment/Chandra2018_STAR_SB/1p_out"
if [ ! -d $FirstPass_SB ]
then
